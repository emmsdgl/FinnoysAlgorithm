...
if ($action === 'list') {
    ...
    foreach ($availability_records as &$record) {
        if (strpos($record['time_slot'], '-') !== false) {
            list($record['time_in'], $record['time_out']) = explode('-', $record['time_slot']);
        } else {
            $record['time_in'] = $record['time_slot'];
            $record['time_out'] = '';
        }
    }
}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-4">
                                        ...
                                        No availability records found.<br>
                                ...
                                <tr>
                                    ...
                                    <!-- <td class="text-muted"><?php echo date('M j', strtotime($record['created_at'])); ?></td> -->
